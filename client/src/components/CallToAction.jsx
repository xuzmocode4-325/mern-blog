...
const CallToAction = () => {
  return (
    <div className="flex flex-col sm:flex-row border border-green-400 justify-between
    items-center rounded-tl-2xl rounded-br-2xl rounded-tr-3xl text-center p-5">
      ...
      <div className="p-7 flex-1">
        <img className='post-image h-auto object-cover w-72 mx-auto' src="https://img.freepik.com/free-vector/dj-action_1045-152.jpg" alt="" />
      </div>
    </div>
  )
}
